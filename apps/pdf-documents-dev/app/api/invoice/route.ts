import { generateInvoiceAsync, IInvoiceInfoDto } from "@repo/pdf-documents-generator";
...
export async function GET() {
  ...
  const content: Buffer = await generateInvoiceAsync(invoice);
  const body: Uint8Array<ArrayBuffer> = new Uint8Array(content);
